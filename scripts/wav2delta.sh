...
if [[ $# != 8 ]]; then
   echo "$0 mfcc_order mfcc_numfilters input.wav output.mfcc output.delta_raw output.static output.d1 output.d2"
   exit 1
fi
...
fmatrix_delta_static -f 3 $outputfile_delta_raw $base.static
cat $base.static >> $outputfile_static

fmatrix_delta_dynamic_1 -f 3 $outputfile_delta_raw $base.d1
cat $base.d1 >> $outputfile_d1

fmatrix_delta_dynamic_2 -f 3 $outputfile_delta_raw $base.d2
cat $base.d2 >> $outputfile_d2
